...
if __name__ == "__main__":
    etiqueta_input = input("Introduce la etiqueta que deseas buscar ('todas' para procesar todas las etiquetas): ").strip()
    ...
    if etiqueta_input == "todas":
        ...
        if len(dudas) > 5:
            ...
            print(f"Se ha creado la nota 'Dudas {etiqueta_input}.md' con {len(dudas)} dudas.")
        else:
